...
const settings: TinySliderProps = {
    lazyload: true,
    controls: false,
    mouseDrag: true,
    loop: true,
                                ...
                                <div className="tiny-slide" key={index}>
                                    <div className="customer-testi">
                                        ...
                                        <div className="text-center mt-5">
                                            <Image src={item.image} height={0} width={0} sizes="100vw" style={{ width: "100%", height: "auto" }} className="h-14 w-14 rounded-full shadow-md mx-auto mb-1" alt="" />
